...
export function RecycleWorkspace({ entries: initialEntries, userRole }: { entries: RecycleEntryView[]; userRole: "user" | "admin" }) {
  ...
  const currentPage = Math.min(page, Math.max(1, Math.ceil(entries.length / pageSize)));
