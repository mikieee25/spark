...
type EntryDataTransferItem = DataTransferItem & { webkitGetAsEntry?: () => Entry | null };
...
export async function filesFromDropItems(items: readonly DataTransferItem[]): Promise<FolderUploadItem[]> {
