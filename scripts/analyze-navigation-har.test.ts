        ...
        entries: [
          {
            ...
            request: {
              method: "GET",
              url: "http://spark.test/api/files?path=Reports",
            },
            response: {
              status: 200,
              headers: [
                {
                  name: "Server-Timing",
                  value:
                    "auth;dur=1.0, path;dur=2.0, directory;dur=3.0, readdir;dur=4.0, metadata;dur=4980.0, sort;dur=1.0, list;dur=5000.0, total;dur=5003.0",
                },
              ],
              content: { size: 20 },
            },
